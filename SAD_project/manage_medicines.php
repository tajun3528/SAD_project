  ...
  <div class="main">
    ...
    <div class="form-section">
      ...
      <form action="add_medicine.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="category" placeholder="Category (e.g., Antibiotic)" required>
        <textarea name="recommendation" rows="4" placeholder="Recommendation (Disease Name)" required></textarea>
        <input type="number" name="quantity" placeholder="Available Quantity" required>
        <input type="number" step="0.01" name="price" placeholder="Price per Piece (৳)" required>

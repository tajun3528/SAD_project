...
<head>
  ...
  <style>
    ...
    .back-btn:hover, .order-btn:hover {
      background-color: #023e8a;
    }
  </style>
</head>
<body>
  ...
  <div class="container">
    ...
    <img src="<?php echo $medicine['image_path']; ?>" alt="Medicine Image">
    <p><strong>Category:</strong> <?php echo htmlspecialchars($medicine['category']); ?></p>
    <p><strong>Recommendation:</strong> <?php echo htmlspecialchars($medicine['recommendation']); ?></p>
    <p><strong>Details:</strong> <?php echo nl2br(htmlspecialchars($medicine['details'])); ?></p>
    <p><strong>Quantity Available:</strong> <?php echo htmlspecialchars($medicine['quantity']); ?> pcs</p>
    <p><strong>Price per Piece:</strong> ৳<?php echo htmlspecialchars(number_format($medicine['price_per_piece'], 2)); ?></p>
    <p><strong>Added on:</strong> <?php echo date("d M Y", strtotime($medicine['created_at'])); ?></p>
    <a href="user_pov_medicine_list.php" class="back-btn">← Back to Medicines</a>
    <a href="add_to_cart.php?type=medicine&id=<?php echo $medicine['id']; ?>" class="order-btn">Add to Cart</a>
  </div>
</body>
</html>